    ...
    const handleDelete = (id) => {
        ...
        swalWithBootstrapButtons.fire({
            ...
            if (result.isConfirmed) {
                router.delete(route('unit.delete', id));
            }
        });
    }
                    ...
                    <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                        <div className="border-b border-slate-100">
                            <div className="p-6 text-gray-900 flex items-center justify-between">
                                <h4 className="text-lg font-semibold">Data Unit</h4>
                                <LinkPrimary href={route('unit.add')}>Add New</LinkPrimary>
                            </div>
                        </div>
                                                ...
                                                <tr key={index} className="bg-white border-b border-gray-200">
                                                    ...
                                                    <td className="px-6 py-4 text-right">
                                                        <div className="flex items-center gap-1 justify-end">
                                                            <LinkSecondary href={route('unit.edit', item.id)} data-tooltip-id="my-tooltip" data-tooltip-content="Edit Data"><RiEdit2Line/></LinkSecondary>
